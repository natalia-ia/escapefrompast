...
# Fase_2/fase2/puzzles/babbage_lovelace.py e Fase_9/puzzle_terminal.py já
# usam: {"estrelas": 1-3, "completo": true, "tempo": "MM:SS"} ("tempo" é
# quanto o jogador LEVOU pra resolver, não quanto sobrou no timer). Fica
# na raiz de Pygame/ (uma pasta acima desta, Fase_4/ -> Pygame/), fora de
# qualquer fase específica -- mesmo espírito autocontido do resto do
# repositório (cada fase grava sua própria chave, sem importar de outra).
# ---------------------------------------------------------------------------
...
# em que o jogador vence (mesmos limiares usados na Fase 2 e na Fase 9,
# pra estrela significar a mesma coisa em todas as fases).
...
class Jogo:
    ...
    def __init__(self, inventario=None, character_image=None, character_name="Jogador", genero="m"):
        ...
        # que fase2.run()/Fase_9.Jogo() já recebem do menu (ver
        # Pygame/menu/jogo.py) -- assim o personagem escolhido lá
        ...
        # nesta fase); quem decide o sprite do avatar é `genero`, igual
        # às outras fases.
        pygame.init()
        ...
        # índice do personagem ativo -- 0 (Personagem 1/masculino) ou 1
        # (Personagem 2/feminino), de acordo com o `genero` escolhido no
        # menu (ver __init__ acima), em vez de sempre 0.
        self.personagem_selecionado = 1 if genero == "f" else 0
        _sprites_jogador = self.opcoes_personagens[self.personagem_selecionado]

        self.jogador = Jogador(
            frame_parado=_sprites_jogador["parado"],
            frames_andando=_sprites_jogador["andando"],
    ...
    def validar_senha_capsula(self):
        ...
        if self.caixa_resposta_cena4.texto == SENHA_CAPSULA:
            ...
            # babbage_lovelace.py usa ao resolver o puzzle. Não é
            # mostrado nesta tela (ver Pygame/Fase_2/fase2/fase2.py e
