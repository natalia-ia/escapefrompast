...
ASSETS = {
    ...
    # Duas variantes da tela de introdução: o cientista explica a fase
    # com um cenário/diálogo diferente dependendo de qual personagem foi
    # escolhido no menu principal do jogo (fundo_intro1 = personagem 1,
    # fundo_intro2 = personagem 2).
    ...
    # fundo_intro1/2 (depende do personagem escolhido no menu principal).
...
class Jogo:
    ...
    def __init__(self, inventario=None, character_image=None, character_name=None, genero="m"):
        ...
        # Escolhe a variante certa conforme o personagem vindo do menu
        # principal (self.personagem_escolhido == 1 ou 2).
        ...
        # Escolhe a variante certa conforme o personagem vindo do menu
        # principal (mesma regra usada no fundo_intro acima).
        self.img_vitoria = (
